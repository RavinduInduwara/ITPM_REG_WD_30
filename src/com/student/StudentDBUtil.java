...
public class StudentDBUtil {
	...
	public static boolean validate(String username, String password) {
		...
		//boolean isSuccess = false;
		 ...
		 try {
			 ...
			 String sql = "SELECT * FROM educlue.student WHERE username = '"+username+"' and password = '"+password+"'";
	...
	ArrayList<Student> std = new ArrayList<>();
			...
			try {
				...
				stmt = con.createStatement();
				String sql = "SELECT * FROM educlue.student WHERE username = '"+userName+"'";
				rs = stmt.executeQuery(sql);
	...
	public static boolean insertstudent(String name, String boy, String gender, String age, String grade, String email, String contact, String address, 
		...
		try {
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "insert into educlue.student values (default, '"+name+"', '"+boy+"', '"+gender+"', '"+age+"', '"+grade+"', '"+email+"', '"+contact+"', '"+address+"', '"+gname+"', '"+gtype+"',  '"+gemail+"', '"+gaddress+"','"+gcontact+"', '"+occupation+"', '"+username+"', '"+password+"')";
	...
	public static boolean updatestudent (String id, String name, String boy, String gender, String age, String grade, String email, String contact, String address,
		...
		try {
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "UPDATE educlue.student SET name = '"+name+"', boy = '"+boy+"', gender = '"+gender+"', age = '"+age+"'"
	...
	public static List<Student> getStudentDetails(String Id){
		...
		try {
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "SELECT * FROM educlue.student WHERE id = '"+convertedID+"'";
			rs = stmt.executeQuery(sql);
	...
	public static boolean deleteStudent(String id) {
		...
		try {
			...
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "DELETE FROM educlue.student WHERE id = '"+convId+"' ";
    ...
    public static List<Student> SearchStudent(String Id){  // , String name
		...
		try {
			...
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from educlue.student where id='"+Id+"'";// and name='"+name+"'
			rs = stmt.executeQuery(sql);
    ...
    public static boolean validate(String Id) {
		...
		try {
			...
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from educlue.student where id='"+Id+"'";
			rs = stmt.executeQuery(sql);
