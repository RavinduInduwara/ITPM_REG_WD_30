...
/**
 * Servlet implementation class MaterialViewAllServlet
 */
@WebServlet("/MaterialViewAllServlet")
public class MaterialViewAllServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Connection conn = null;
		  ...
		  String query = "select * from educlue.materials order by id desc";
		 ...
		 System.out.println("allList " + all_list);
		  ...
		  String nextJSP = "/materialViewAll.jsp";
