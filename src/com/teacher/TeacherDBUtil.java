...
public class TeacherDBUtil {
	...
	public static boolean validate(String username, String password) {
		...
		try {
			...
			String sql = "select * from educlue.teacher where username='"+username+"' and password='"+password+"'";
	...
	public static List<Teacher> getTeacher(String userName) {
		...
		try {
			...
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from educlue.teacher where username='"+userName+"'";
			rs = stmt.executeQuery(sql);
    ...
    public static boolean insertteacher(String name,String nic,String gender,String subject,String address,String email,String phone,String experience,String eduqualifications,String username,String password) {
    	...
    	try {
    		con = DBConnect.getConnection();
    		stmt = con.createStatement();
    	    String sql = "insert into educlue.teacher values (default,'"+name+"','"+nic+"','"+gender+"','"+subject+"','"+address+"','"+email+"','"+phone+"','"+experience+"','"+eduqualifications+"','"+username+"','"+password+"')";
    ...
    public static boolean updateteacher(String tid,String name,String nic,String gender,String subject,String address,String email,String phone,String experience,String eduqualifications,String username,String password) {
    	...
    	try {
    		...
    		con = DBConnect.getConnection();
    		stmt = con.createStatement();
    		String sql = "update educlue.teacher set name='"+name+"',nic='"+nic+"',gender='"+gender+"',subject='"+subject+"',address='"+address+"',email='"+email+"',phone='"+phone+"',experience='"+experience+"',eduqualifications='"+eduqualifications+"',username='"+username+"',password='"+password+"'"
    				+ "where tid='"+tid+"'";  
    		int rs = stmt.executeUpdate(sql);
    ...
    public static List<Teacher> getTeacherDetails(String tId) {  
    	...
    	try {
    		...
    		con = DBConnect.getConnection();
    		stmt = con.createStatement();
    		String sql = "select * from educlue.teacher where tid='"+tId+"'";      //String sql = "select * from teacher where id='"+convertedID+"'";
    		rs = stmt.executeQuery(sql);
    ...
    public static boolean deleteTeacher(String tid) { 
    	...
    	try {
    		...
    		con = DBConnect.getConnection();
    		stmt = con.createStatement();
    		String sql = "delete from educlue.teacher where tid='"+tid+"'";
...
/***************************Codes for Search****************************************************/  
     ...
     public static List<Teacher> SearchTeacher(String tId){  
		...
		try {
			...
			con = DBConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from educlue.teacher where tid='"+tId+"'";
			rs = stmt.executeQuery(sql);
