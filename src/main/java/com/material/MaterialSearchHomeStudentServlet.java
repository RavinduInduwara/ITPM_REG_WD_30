...
public class MaterialSearchHomeStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Connection conn = null;
		  ...
		  String query = "select * from educlue.materials where materials.material_title like '"+title+"%' or materials.material_title like '%"+title+"' order by materials.id desc";
