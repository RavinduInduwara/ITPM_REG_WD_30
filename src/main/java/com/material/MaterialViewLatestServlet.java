...
/**
 * Servlet implementation class MaterialViewLatestServlet
 */
@WebServlet("/MaterialViewLatestServlet")
public class MaterialViewLatestServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			Connection conn = null;
			 /** String url = "jdbc:mysql://localhost:3306/course_materials";
			  ...
			  String query = "select * from materials.materials order by materials.id desc limit 3";
			 ...
			 System.out.println("allList " + all_list);
			  ...
			  String nextJSP = "/materialHome.jsp";
