...
public static boolean materialInsert(String teacherID, String title, String grade, String subject, String link) {
		...
		try {
		   ...
		   // Date date = formatter.parse(addedDate);
			...
			String sql = "INSERT INTO materials.materials VALUES (default, '"+materialTeacher+"', '"+title+"', '"+materialAddedDate+"', '"+materialGrade+"', '"+subject+"', '"+link+"')";
...
public static boolean materialDelete(String id) {
	...
	try {
		...
		con = DBConnect.getConection();
		stat = con.createStatement();
		String sql = "DELETE FROM materials.materials WHERE id='"+intId+"'";
...
public static List<Material> getMaterialDetails(String materialID) {
	...
	try {
		...
		con = DBConnect.getConection();
		stat = con.createStatement();
		String sql = "SELECT * FROM materials.materials WHERE id='"+intID+"'";
...
public static boolean updateMaterial(String id, String teacherID, String title, String grade, String subject, String link) {
	...
	try {
		...
		con = DBConnect.getConection();
		stat = con.createStatement();
		String sql = "UPDATE materials.materials SET teacher_id = '"+materialTeacher+"', material_title = '"+title+"', added_date = '"+materialAddedDate+"', grade = '"+materialGrade+"', subject = '"+subject+"', material_link = '"+link+"' WHERE id = '"+materialID+"'";
