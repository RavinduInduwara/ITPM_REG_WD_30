            ...
            <footer class="text-off-white">
                ...
                <div class="footer">
                    <div class="container text-center wow fadeIn" data-wow-delay="0.4s">
                        <p class="copyright">Copyright &copy; 2022 - Designed By PASIDU PRAMODYA <a href="https://www.behance.net/poljakova" class="theme-author"> </a> &amp; Developed by ASHAN PRAMODYA<a href="http://www.imransdesign.com/" class="theme-author"></a></p>
                    </div>
                </div>
