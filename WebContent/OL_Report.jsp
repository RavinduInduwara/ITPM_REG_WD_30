    	...
    	<div class="body">
			...
			<!--    Begin Services -->
             <section id="payment-section" class="page text-white parallax" data-stellar-background-ratio="0.5">
				...
				ResultSet rs = null;
				%>
				<h2 align="center"><font><strong>Ordinary level Student</strong></font></h2><br><br><br><br>
				...
				String sql ="SELECT * FROM student WHERE grade='10' OR grade='11'";
				        ...
				        $("body").on("click", "#btnDownload", function () {
				            html2canvas($('#tblCustomers')[0], {
				                onrendered: function (canvas) {
				                    ...
				                    pdfMake.createPdf(docDefinition).download("OrdinariLevel.pdf");
				                }
				            });
				        });
				    </script>
