...
<html lang="en-US">
    ...
    <!--    Begin Services -->
			...
			ResultSet rs = null;
			%>
			<h2 align="center"><font><strong>Advanced Level Student</strong></font></h2><br><br><br><br>
			<table id="tblCustomers"  style="width:80% ; color:#000000; margin:auto;">
			<tr>
			...
			String sql ="SELECT * FROM student WHERE grade='12' OR grade='13'";
			...
			<br><br>
			<input type="button" id="btnDownload" value="DOWNLOAD" style="margin-left:10% ;" />
			        ...
			        $("body").on("click", "#btnDownload", function () {
			            html2canvas($('#tblCustomers')[0], {
			                onrendered: function (canvas) {
			                    ...
			                    pdfMake.createPdf(docDefinition).download("AdvancedLevel.pdf");
			                }
			            });
			        });
			    </script>
