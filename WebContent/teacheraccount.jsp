...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
  ...
  font-size: 16px;
    ...
    <body data-spy="scroll" data-target="#main-navbar">
		...
		<button type="submit" name="delete" class="button4	" data-wow-delay="0.4s">Delete My Account</button></a>
		<br><br>
		<a href="dashboardT.html"><button type="button" class="btn wow bounceInRight" data-wow-delay="0.8s">Go to Teacher Dashboard</button></a>
